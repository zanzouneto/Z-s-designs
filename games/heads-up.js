...
function getWordsForTheme(theme) {
    if (theme === 'animals') {
        return [
            ...
            'Meerkat', 'Badger', 'Weasel', 'Ferret', 'Mole', 'Vole', 'Hamster', 'Guinea Pig', 'Gerbil', 'Chinchilla', 
        ...
        return [
            ...
            'Finding Nemo', 'Frozen', 'Harry Potter', 'Lord of the Rings', 
            ...
            'The Mandalorian', 'Narcos', 'The Witcher', 'Better Call Saul', 
            ...
            'The Marvelous Mrs. Maisel', 'The Handmaid\'s Tale', 'Ozark', 
            'Lucifer', 'BoJack Horseman', 'Fleabag', 'Brooklyn Nine-Nine', 
            'The Boys', 'Mindhunter', 'Hannibal', 'Dark', 'Lost', 
            ...
            'Narcos', 'Dark', 'Black Mirror', 'The Crown', 
        ...
        'Michael B. Jordan', 'Chris Pratt', 'Zendaya', 'Gigi Hadid', 'Zac Efron',
        ...
        'Margot Robbie', 'Idris Elba', 'Ariana DeBose', 'Pedro Pascal', 'Zendaya',
        'Hailey Baldwin', 'Timothée Chalamet', 'Zendaya', 'Cara Delevingne', 'Olivia Rodrigo',
        'Harry Styles', 'Hailee Steinfeld', 'Millie Bobby Brown', 'Taron Egerton', 'Saoirse Ronan',
        'Eddie Redmayne', 'Florence Pugh', 'Shawn Mendes', 'Zendaya', 'Anya Taylor-Joy',
        ...
        return [
            ...
            'Badminton', 'Table Tennis', 'Volleyball', 'Handball', 'Archery',
            ...
            'Petanque', 'Croquet', 'Horseshoes', 'Tug of War', 'Sack Race',
            'Three-Legged Race', 'Egg and Spoon Race', 'Sack Race', 'Tug of War',
        ...
        return [
            ...
            'The Picture of Dorian Gray', 'The Catcher in the Rye', 'Catch-22', 'Slaughterhouse-Five', 'One Hundred Years of Solitude',
            ...
            'The Count of Monte Cristo', 'The Three Musketeers', 'Les Misérables', 'The Man in the Iron Mask', 'The Phantom of the Opera',
            'The Odyssey', 'The Iliad', 'The Aeneid', 'The Divine Comedy', 'Paradise Lost',
            ...
            'Candide', 'The Sorrows of Young Werther', 'Faust', 'The Red and the Black', 'Madame Bovary',
            'Sentimental Education', 'The Three Musketeers', 'The Count of Monte Cristo', 'Les Misérables', 'The Hunchback of Notre-Dame',
            'War and Peace', 'Anna Karenina', 'Crime and Punishment', 'The Brothers Karamazov', 'Doctor Zhivago',
            'One Hundred Years of Solitude', 'Love in the Time of Cholera', 'Chronicle of a Death Foretold', 'Of Love and Other Demons', 'The Autumn of the Patriarch'
        ];
    } else if (theme === 'songs') {
        return [
            ...
            'London Calling', 'Rock Lobster', 'In My Life', 'Tiny Dancer', 'Wish You Were Here',
            'Walk on the Wild Side', 'September Gurls', 'The Message', 'The End', 'Purple Rain',
            'Born in the U.S.A.', 'Good Times', 'With or Without You', 'Runaway', 'Tumbling Dice',
            ...
            'Thunder Road', 'More Than a Feeling', 'Sweet Jane', 'All You Need Is Love', 'Bad Moon Rising',
            'Desperado', 'The Boys of Summer', 'With a Little Help from My Friends', 'Heart of Gold', 'Thunder Road',
            'Good Lovin\'', 'Landslide', 'The Weight', 'Miss You', 'Can\'t Buy Me Love',
            ...
            'River Deep, Mountain High', 'Fortunate Son', 'Your Song', 'Don\'t Think Twice, It\'s All Right', 'Tiny Dancer',
            'Nothing Compares 2 U', 'Help Me', 'Subterranean Homesick Blues', 'We Will Rock You', 'My Sweet Lord',
            'Whole Lotta Love', 'Black Dog', 'Walk This Way', 'Stairway to Heaven', 'Bohemian Rhapsody',
            'Sweet Child o\' Mine', 'Back in Black', 'Kashmir', 'Free Bird', 'Hotel California',
            'Born to Run', 'Sympathy for the Devil', 'Imagine', 'Billie Jean', 'Like a Rolling Stone',
            'Johnny B. Goode', 'I Heard It Through the Grapevine', 'What\'s Going On', 'Respect', 'Good Vibrations',
            'Smells Like Teen Spirit', 'When Doves Cry', 'I Want to Hold Your Hand', 'Purple Haze', 'I Walk the Line',
            'Brown Sugar', 'London Calling', 'Superstition', 'Let\'s Get It On', 'Beat It',
            'Rock Lobster', 'The Message', 'Hey Ya!', 'Kiss', 'Super Freak',
            'Tainted Love', 'Sweet Dreams (Are Made of This)', 'Blue Monday', 'Don\'t You Want Me', 'Billie Jean',
            'Like a Virgin', 'Hungry Like the Wolf', 'Every Breath You Take', 'Pour Some Sugar on Me', 'Livin\' on a Prayer',
            'Sweet Child o\' Mine', 'Straight Outta Compton', 'Smells Like Teen Spirit', 'Enter Sandman', 'Losing My Religion',
            ...
            'Hey Ya!', 'Crazy in Love', 'Yeah!', 'Gold Digger', 'Irreplaceable',
            'Umbrella', 'Single Ladies (Put a Ring on It)', 'I Gotta Feeling', 'Poker Face', 'Empire State of Mind',
            'Rolling in the Deep', 'Party Rock Anthem', 'Somebody That I Used to Know', 'Call Me Maybe', 'Thrift Shop',
            ...
            'Stay', 'Happier Than Ever', 'Ghost', 'Way 2 Sexy', 'Need to Know',
            ...
            'One Right Now', 'The Joker And The Queen', 'I Hate U', 'My Universe', 'Love Again', 
            ...
            'The Supremes', 'The Ronettes', 'The Shirelles', 'The Chiffons', 'The Crystals',
            'Chuck Berry', 'Little Richard', 'B.B. King', 'Muddy Waters', 'John Lee Hooker',
            'Howlin\' Wolf', 'Bo Diddley', 'Ray Charles', 'Fats Domino', 'Louis Armstrong',
        ...
        return [
            ...
            'Captain Hook', 'Peter Pan', 'Wendy', 'Tinker Bell', 'The Lost Boys',
            ...
            'The Emperor', 'The Nightingale', 'The Steadfast Tin Soldier', 'The Little Mermaid', 'The Snow Queen',
            'The Ice Queen', 'The Little Match Girl', 'Thumbelina', 'The Ugly Duckling', 'The Emperor\'s New Clothes',
            'The Nightingale', 'The Steadfast Tin Soldier', 'The Little Mermaid', 'The Snow Queen', 'The Ice Queen',
            'The Little Match Girl', 'Thumbelina', 'The Ugly Duckling', 'The Emperor\'s New Clothes', 'The Nightingale',
            'The Steadfast Tin Soldier', 'The Little Mermaid', 'The Snow Queen', 'The Ice Queen', 'The Little Match Girl',
            'Thumbelina', 'The Ugly Duckling', 'The Emperor\'s New Clothes', 'The Nightingale', 'The Steadfast Tin Soldier',
            'The Little Mermaid', 'The Snow Queen', 'The Ice Queen', 'The Little Match Girl', 'Thumbelina',
            'The Ugly Duckling', 'The Emperor\'s New Clothes', 'The Nightingale', 'The Steadfast Tin Soldier', 'The Little Mermaid',
            'The Snow Queen', 'The Ice Queen', 'The Little Match Girl', 'Thumbelina', 'The Ugly Duckling',
            'The Emperor\'s New Clothes', 'The Nightingale', 'The Steadfast Tin Soldier', 'The Little Mermaid', 'The Snow Queen',
            'The Ice Queen', 'The Little Match Girl', 'Thumbelina', 'The Ugly Duckling', 'The Emperor\'s New Clothes',
            'The Nightingale', 'The Steadfast Tin Soldier', 'The Little Mermaid', 'The Snow Queen', 'The Ice Queen',
            'The Little Match Girl', 'Thumbelina', 'The Ugly Duckling', 'The Emperor\'s New Clothes', 'The Nightingale'
        ];    
